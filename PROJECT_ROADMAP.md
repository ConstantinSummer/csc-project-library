...
| 7 | [`csc-ai-prompt-evaluation-lab`](https://github.com/ConstantinSummer/csc-ai-prompt-evaluation-lab) | Prompt Evaluation Lab | Python | Intermediate | Available | Prompt design, structured outputs, comparison, evaluation | Testing prompts the way software is tested |
