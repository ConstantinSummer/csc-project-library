...
| 7 | `csc-ai-prompt-evaluation-lab` | Prompt Evaluation Lab | Python | Foundation / Intermediate | Planned | Prompt design, structured outputs, comparison, evaluation | Testing prompts the way software is tested |
